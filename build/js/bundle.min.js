function darkMode(){const e=window.matchMedia("(prefers-color-scheme: dark)");e.matches?document.body.classList.add("darkMode"):document.body.classList.remove("darkMode"),e.addEventListener("change",(function(){e.matches?document.body.classList.add("darkMode"):document.body.classList.remove("darkMode")}));document.querySelector(".theme-icon").addEventListener("click",(function(){document.body.classList.toggle("darkMode")}))}function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navigationResposive)}function navigationResposive(){const e=document.querySelector(".nav");e.classList.contains("view-nav")?e.classList.remove("view-nav"):e.classList.add("view-nav")}
